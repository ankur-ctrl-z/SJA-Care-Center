    ...
    <div>
      <div className="container mb-32 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center font-semibold text-xl mt-10 pt-24">
          <h1 className="heading tracking-wide md:mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto px-4 md:px-0 mt-10">
          ...
          {/* Right column */}
          <div className="font-semibold tracking-wide mt-10 md:-mt-8">
            <p className="leading-9 text-xl mt-5 font-meidum text-center md:text-left">
              <h3 className="text-2xl sm:text-2xl font-bold mb-5 mt-10">
                At Dr. D S Dubey's clinic, we offer expert massage therapy
                services to complement our chiropractic treatments. Our licensed
                massage therapists specialize in techniques designed to
                alleviate muscle tension, improve circulation, and promote
              ...
              <ul className="list-disc list-inside mb-5">
                <li className="text-base sm:text-lg leading-relaxed">
                  Pain Relief: Soothe aches and pains, including back pain and
                  neck tension.
                </li>
                <li className="text-base sm:text-lg leading-relaxed">
                  Stress Reduction: Relax and unwind with calming massage
                  techniques.
                </li>
                <li className="text-base sm:text-lg leading-relaxed">
                  Improved Mobility: Enhance flexibility and movement for better
                  daily living.
                </li>
                <li className="text-base sm:text-lg leading-relaxed">
                  Faster Healing: Aid in recovery from injuries by improving
                  circulation and reducing inflammation.
                </li>
              </ul>
              <p className="text-base sm:text-lg leading-relaxed mb-5">
                Book a session today and discover the benefits of massage
        ...
        <div className="flex flex-wrap justify-center -mt-24 w-full mb-14 md:-mt-20 ">
          <div className="flex justify-center font-semibold tracking-wide mt-20">
            <h1 className="heading mt-10">
              {" "}
              Services under{" "}
              <span className="text-orange-600">Massage Therapy</span>
            </h1>
          </div>
