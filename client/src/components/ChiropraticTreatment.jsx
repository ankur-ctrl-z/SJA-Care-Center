...
import BackPain from '../assets/Chiropractic.jpeg'
...
import Scoliosis from "../assets/Chiropractic-Treatment/Scoliosis 1.png";
import BulgingDisc from "../assets/Chiropractic-Treatment/Bulging-Disc1.png";
...
import CervicalSpondylosis from "../assets/Chiropractic-Treatment/Cervical Spondolysis1.png";
import SlippedDisc from "../assets/Chiropractic-Treatment/Slip Disc1.png";
import AnkylosingSpondylitis from "../assets/Chiropractic-Treatment/Ankylosing Spondylitis 1.png";
    ...
    <div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto px-4 md:px-0 mt-10">
          ...
          {/* Right column */}
          <div className="font-semibold tracking-wide mt-10 md:-mt-5">        
        ...
        <div className="flex flex-wrap justify-center -mt-24 w-full ">
          <div className="flex justify-center font-semibold tracking-wide mt-20">
            <h1 className="heading mt-10">
              {" "}
              Services under{" "}
              <span className="text-orange-600">Chiropractic Treatment</span>
            </h1>
          </div>
            ...
            <div className="h-96 w-72 border rounded-3xl border-black m-1">
              <div className="flex ml-20 justify-center">
                <img
                  src={Lordosis}
                  alt="Lordosis"
                  className="h-72 w-80 flex rounded-3xl p-2"
                />
              </div>
              <div>
                <h1 className="font-semibold flex justify-center text-2xl tracking-wide mt-1">
