...
const ClientFeedback = () => {
  return (
    <div className="m-5 md:mt-10">
      ...
      <div className="flex-col grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:ml-8 lg:ml-14 xl:ml-20 lg:gap-4 items-center sm:flex-row flex-wrap justify-center mt-10 md:justify-around">
